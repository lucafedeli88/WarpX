...
#pragma omp parallel if (Gpu::notInLaunchRegion())
        ...
        for (WarpXParIter pti(*pc_source, lev, info); pti.isValid(); ++pti)
        {
            ...
            auto Transform = PhotonEmissionTransformFunc(
                  ...
                  pc_source->GetRealCompIndex("chi_lepton_at_creation") - WarpXParticleContainer::NArrayReal,
                  pc_source->GetRealCompIndex("E_field_at_creation") - WarpXParticleContainer::NArrayReal,
                  pc_source->GetRealCompIndex("B_field_at_creation") - WarpXParticleContainer::NArrayReal,

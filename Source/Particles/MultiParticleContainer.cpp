...
#pragma omp parallel if (Gpu::notInLaunchRegion())
        ...
        for (WarpXParIter pti(*pc_source, lev, info); pti.isValid(); ++pti)
        {
            ...
            auto Transform = PhotonEmissionTransformFunc(
                  ...
                  pc_product_phot->GetRealCompIndex("chi_lepton_at_creation") - WarpXParticleContainer::NArrayReal,
                  pc_product_phot->GetRealCompIndex("E_field_at_creation") - WarpXParticleContainer::NArrayReal,
                  pc_product_phot->GetRealCompIndex("B_field_at_creation") - WarpXParticleContainer::NArrayReal,
